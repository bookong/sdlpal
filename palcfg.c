...
)
{
	...
	if (gConfig.eMIDISynth == SYNTH_TINYSOUNDFONT && !UTIL_IsFileExist(gConfig.pszSoundBank)) {
		UTIL_LogOutput(LOGLEVEL_ERROR, "TinySoundFont enabled but no valid sf2 file specified");
